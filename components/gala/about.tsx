...
function SectionTitle({
  ...
  return (
    <div className="text-center">
      <p className="font-script text-2xl text-royal sm:text-3xl">{overline}</p>
      ...
      <div className="mx-auto max-w-7xl px-6">
        ...
        <div className="mt-16 grid items-center gap-12 lg:grid-cols-2 lg:gap-20">
          <div className="relative">
            ...
            <div className="absolute -bottom-6 -right-6 hidden border border-royal bg-royal px-8 py-6 text-center sm:block">
              <p className="font-heading text-4xl font-bold text-[oklch(0.98_0.005_85)]">
                2026
              </p>
              <p className="mt-1 text-xs uppercase tracking-[0.2em] text-[oklch(0.98_0.005_85)]/80">
            ...
            <div className="mt-10 grid grid-cols-2 gap-px overflow-hidden border border-border bg-border">
              {stats.map((s) => (
                <div key={s.label} className="bg-card px-6 py-8 text-center">
                  <p className="font-heading text-3xl font-bold text-royal sm:text-4xl">
                    {s.value}
                  </p>
