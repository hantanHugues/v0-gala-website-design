      ...
      <div className="mx-auto max-w-6xl px-6">
        <div className="text-center">
          ...
          <p className="mx-auto mt-6 max-w-2xl text-pretty leading-relaxed text-muted-foreground">
            Retour en images sur deux décennies de soirées mémorables, de
            rencontres inspirantes et de célébrations de l&apos;excellence.
          </p>
        </div>

        <div className="mt-16 grid auto-rows-[180px] grid-cols-2 gap-3 sm:auto-rows-[200px] sm:grid-cols-4 sm:gap-4">
          {photos.map((photo, i) => (
            <button
              key={photo.src}
              onClick={() => setActive(i)}
